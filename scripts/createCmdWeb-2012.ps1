#requires -version 3
##########################################################################
# Script Name   : createCmdWeb-2012.ps1
# Version       : 3.0
...
# Files         : createCmdWeb-2012.ps1   (this file)
#               : _CMDWEBgroups.csv
#               : _CMDWEBaccounts.csv
#               : bccslib5r2.ps1
# Paths         : Files must be located in C:\Scripts directory
# Version 2.0   : 2013/04/15 - Initial Release
#         2.1   : 2013/07/01 - Added account creation code and .csv
#         3.0   : 2014/11/25 - Updated for Windows 2012
##########################################################################
...
$logfile = $ENV:COMPUTERNAME + "_createCmdWeb-2012_" + $currdate + ".log"
...
"===== START INSTALLATION - createCmdWeb-2012.ps1 =====" | Write-log
...
if(!(test-path "C:\Scripts\createCmdWeb-2012.ps1"))
{
   Clear-Host
   Write-Host -foregroundcolor YELLOW "`n Script must be stored and executed from C:\Scripts directory!`n`n"
   "ERROR: createCmdWeb-2012.ps1 not in c:\scripts directory" | Write-Log
   "===== STOP INSTALLATION =====" | Write-log
   EXIT
}
...
displayString "This script will create the required OUs, groups, and accounts."
Write-Host
...
Write-host -foregroundcolor YELLOW " Command Web Accounts`n"
