#requires -version 3
##########################################################################
# Script Name   : createC2Iaccounts-2008.ps1
# Version       : 1.0
...
# Files         : createC2Iaccounts-2008.ps1   (this file)
#               : bccslib5r2.ps1
#               : _C2Igroups.csv
...
"===== START INSTALLATION - createC2Iaccounts-2008.ps1 =====" | Write-log
...
Write-host -foregroundcolor YELLOW "`n C2I Security Groups`n"
...
$securepwd = get-Password "Default Password for C2I Security Groups"
